...
\begin{frame}\frametitle{Tutorials}
	...
	\begin{itemize}
		...
		\item	Please have an internet-enabled device in the tutorial (one per group)
	\end{itemize}
\end{frame}
...
\begin{frame}\frametitle{Group selection}
	\begin{itemize}
		...
		\begin{itemize}
			\item	Mutual selection (get to choose 3 of the 4 other members)
...
\begin{frame}\frametitle{Group norms}
	...
	\begin{itemize}
		...
		\item	No one wants to take the lead (fear?)
